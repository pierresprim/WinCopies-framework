...
namespace WinCopies.GUI.Controls.Samples
{
    public partial class NavigationMenu : IconControl
    {
        ...
        public static readonly RoutedEvent OpeningEvent = Register<RoutedEventHandler, NavigationMenu>(nameof(Opening), RoutingStrategy.Bubble);

        public event RoutedEventHandler Opening { add => AddHandler(OpeningEvent, value); remove => RemoveHandler(OpeningEvent, value); }

        public static readonly RoutedEvent ClosingEvent = Register<RoutedEventHandler, NavigationMenu>(nameof(Closing), RoutingStrategy.Bubble);
