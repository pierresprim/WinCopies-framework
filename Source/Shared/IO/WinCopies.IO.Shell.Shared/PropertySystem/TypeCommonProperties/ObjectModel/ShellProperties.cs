...
{
    [PropertyDescriptionFinding(typeof(Shell.Resources.PropertyDescriptions), "{0}Name", "{0}")]
    ...
    [PropertyDescriptionFinding(typeof(Shell.Resources.PropertyDescriptions), "{0}Name", "{0}")]
    public abstract class FileOrFolderShellObjectInfoProperties<TBrowsableObjectInfo, TInnerProperties> : FileSystemObjectInfoProperties<TBrowsableObjectInfo, TInnerProperties>, Shell.PropertySystem.IFileSystemObjectInfoProperties where TBrowsableObjectInfo : IShellObjectInfoBase2 where TInnerProperties : FileSystemInfo
    {
