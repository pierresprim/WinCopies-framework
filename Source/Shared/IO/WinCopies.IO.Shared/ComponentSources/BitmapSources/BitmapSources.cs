...
namespace WinCopies.IO.ComponentSources.Bitmap
{
    ...
    public class IconBitmapSources : BitmapSources2<Icon>
    {
        ...
        protected virtual BitmapSource
#if CS8
            ?
#endif
            TryGetBitmapSource(in ushort size) => ObjectModel.BrowsableObjectInfo.TryGetBitmapSource(InnerObject, size);

        protected override BitmapSource
#if CS8
            ?
#endif
            GetSmall() => TryGetBitmapSource(SmallIconSize);

        protected override BitmapSource
#if CS8
            ?
#endif
            GetMedium() => TryGetBitmapSource(MediumIconSize);

        protected override BitmapSource
#if CS8
            ?
#endif
            GetLarge() => TryGetBitmapSource(LargeIconSize);

        protected override BitmapSource
#if CS8
            ?
#endif
            GetExtraLarge() => TryGetBitmapSource(ExtraLargeIconSize);
    }

    public class BitmapBitmapSources : BitmapSources2<System.Drawing.Bitmap>
    {
        public BitmapBitmapSources(in System.Drawing.Bitmap bitmap) : base(bitmap) { /* Left empty. */ }
