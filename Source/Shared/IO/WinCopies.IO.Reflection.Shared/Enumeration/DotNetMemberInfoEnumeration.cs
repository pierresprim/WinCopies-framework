...
namespace WinCopies.IO.Enumeration.Reflection
{
    ...
    {
        public static System.Collections.Generic.IEnumerable<DotNetMemberInfoItemProvider> From(IDotNetMemberInfoBase dotNetMemberInfo, in System.Collections.Generic.IEnumerable<DotNetItemType> typesToEnumerate, in Predicate<DotNetMemberInfoItemProvider>
#if CS8
                ?
#endif
                func)
        {
            ...
            DotNetMemberInfoItemProvider select(in ParameterInfo p, in bool isReturnParameter) => new
#if !CS9
                DotNetMemberInfoItemProvider
#endif
                (new ParameterInfoItemProvider(p, isReturnParameter), dotNetMemberInfo);
            ...
            void addPropertyMethod(in EnumerableHelper<MethodInfo>.IEnumerableQueue _queue, in MethodInfo
#if CS8
                ?
#endif
                methodInfo)
