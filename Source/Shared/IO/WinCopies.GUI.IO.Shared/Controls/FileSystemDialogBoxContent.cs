...
namespace WinCopies.GUI.IO
{
    ...
    public class FileSystemDialogBoxContent : Control
    {
        ...
        public static readonly DependencyProperty DialogProperty = Register<IFileSystemDialog>(nameof(Dialog));
        ...
        private void SetText()
        {
            ...
            Text = (path.ItemSources?.SelectedItem.SelectedItem ?? path).Name;
        }
        ...
        protected virtual void OnPathPropertyChanged(System.ComponentModel.PropertyChangedEventArgs e)
        {
            switch (e.PropertyName)
            {
                ...
                case nameof(IItemSourceViewModel.SelectedItem):
