        ...
        protected partial class ProcessDataViewModel
        {
            protected partial class BackgroundWorker
            {
                private partial class ProcessorInfo
                {
                    ...
                    {
                        private readonly struct FileValidationProvider : IFileValidationProvider
                        {
                        ...
                        private readonly struct Stack : EnumerableHelper<ITemporaryFileEnumerable>.IEnumerableStack, IEnumerable<EnumerableHelper<ITemporaryFileEnumerable>.ILinkedListNode>
                        {
                            private readonly struct Node : EnumerableHelper<ITemporaryFileEnumerable>.ILinkedListNode
                            {
                            ...
                            private Collections.DotNetFix.Generic.IStackCommon<ITemporaryFileEnumerable> LinkedList => _linkedList;
                            ...
                            public IEnumeratorInfo<ITemporaryFileEnumerable> GetReversedEnumerator() => _linkedList.AsFromType<Collections.Enumeration.IEnumerable<IEnumeratorInfo<ITemporaryFileEnumerable>>>().GetEnumerator();
                            void Collections.DotNetFix.IListCommon.Add(object value) => _linkedList.Add(value);
                            object Collections.DotNetFix.IListCommon.Remove() => _linkedList.Remove();
                            bool Collections.DotNetFix.IListCommon.TryRemove(out object result) => _linkedList.TryRemove(out result);
                            IEnumerator Collections.Extensions.IEnumerable.GetReversedEnumerator() => GetReversedEnumerator();
#if !CS8
                            ...
                            IEnumeratorInfo<ITemporaryFileEnumerable> Collections.Enumeration.IEnumerable<IEnumeratorInfo<ITemporaryFileEnumerable>>.GetEnumerator() => new EnumeratorInfo<ITemporaryFileEnumerable>(GetEnumerable().GetEnumerator());

                            void Collections.DotNetFix.Generic.IListCommon<ITemporaryFileEnumerable>.Add(ITemporaryFileEnumerable value) => _linkedList.Add(value);
                            ITemporaryFileEnumerable Collections.DotNetFix.Generic.IListCommon<ITemporaryFileEnumerable>.Remove() => _linkedList.Remove();
                            bool Collections.DotNetFix.Generic.IListCommon<ITemporaryFileEnumerable>.TryRemove(out ITemporaryFileEnumerable result) => _linkedList.TryRemove(out result);
                            void Collections.DotNetFix.IStackCore.Push(object item) => _linkedList.Push(item);
                            object Collections.DotNetFix.IStackCore.Pop() => _linkedList.Pop();
                            bool Collections.DotNetFix.IStackCore.TryPop(out object result) => _linkedList.TryPop(out result);
                            object Collections.DotNetFix.IPeekable.Peek() => _linkedList.Peek();
                            bool Collections.DotNetFix.IPeekable.TryPeek(out object result) => _linkedList.TryPeek(out result);
#endif
                        }
                        ...
                        public IEnumerable<ActionProvider> GetInstallActions()
                        {
                            ...
                            yield return processor => Error < FatalError ? getProcessAction("Custom actions", false, () =>
                            {
                                ...
                                foreach (IOption option in ProcessData.ModelGeneric.Installer.Options.Where(optionGroup => optionGroup.IsChecked == true).Join().Where(option => option.IsChecked))
