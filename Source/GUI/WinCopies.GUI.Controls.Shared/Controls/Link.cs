...
namespace WinCopies.GUI.Controls
{
    public class Link : Button
    {
        ...
        /// </summary>
        public static readonly DependencyProperty UnderliningModeProperty = DependencyProperty.Register(nameof(UnderliningMode), typeof(LinkUnderliningMode), typeof(Link), new PropertyMetadata(LinkUnderliningMode.UnderlineWhenMouseOverOrFocused));
        ...
        /// </summary>
        public static readonly DependencyProperty NormalForegroundProperty = DependencyProperty.Register(nameof(NormalForeground), typeof(Brush), typeof(Link), new PropertyMetadata(Brushes.Blue));
        ...
        /// </summary>
        public static readonly DependencyProperty HighlightedForegroundProperty = DependencyProperty.Register(nameof(HighlightedForeground), typeof(Brush), typeof(Link), new PropertyMetadata(Brushes.Aqua));
        ...
        /// </summary>
        public static readonly DependencyProperty ActiveForegroundProperty = DependencyProperty.Register(nameof(ActiveForeground), typeof(Brush), typeof(Link), new PropertyMetadata(Brushes.RoyalBlue));
        ...
        /// </summary>
        public static readonly DependencyProperty SeenForegroundProperty = DependencyProperty.Register(nameof(SeenForeground), typeof(Brush), typeof(Link), new PropertyMetadata(Brushes.MediumPurple));
        ...
        /// </summary>
        public static readonly DependencyProperty SeenProperty = DependencyProperty.Register(nameof(Seen), typeof(bool), typeof(Link), new PropertyMetadata(false));
        ...
        public Link() => AddHandler(LinkRun.ClickEvent, new RoutedEventHandler((object sender, RoutedEventArgs e) => e.Handled = true));
