...
namespace WinCopies.IO.AbstractionInterop.Reflection
{
    ...
    public class TypeInfoItemProvider : DotNetItemInfoItemProvider
    {
        ...
        public TypeInfoItemProvider(in TypeInfo
#if CS8
            ?
#endif
            typeInfo, in DotNetItemType itemType) : base(itemType) => TypeInfo = typeInfo;

        public TypeInfoItemProvider(in Type
#if CS8
            ?
#endif
            type, in DotNetItemType itemType) : this(type?.GetTypeInfo(), itemType)
        {
            // Left empty.
        }
    }
