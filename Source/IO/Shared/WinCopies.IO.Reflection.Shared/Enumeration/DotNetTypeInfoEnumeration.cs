...
namespace WinCopies.IO.Enumeration.Reflection
{
    ...
    {
        public static System.Collections.Generic.IEnumerable<DotNetTypeInfoItemProvider> From(IDotNetTypeInfo dotNetTypeInfo, in System.Collections.Generic.IEnumerable<DotNetItemType> typesToEnumerate, in Predicate<DotNetTypeInfoItemProvider>
#if CS8
            ?
#endif
            func)
        {
            ...
            DotNetTypeInfoItemProvider select(Type
#if CS8
                ?
#endif
                t) => new
#if !CS9
                DotNetTypeInfoItemProvider
#endif
                (new TypeInfoItemProvider(t?.GetTypeInfo(), DotNetItemType.BaseTypeOrInterface), dotNetTypeInfo);
