...
{
    public enum BitmapSourcesLinkerLoadStep
    {
        Default = 0,
    ...
    public class BitmapSourcesLinker : BitmapSources<IBitmapSourceProvider>, IBitmapSourcesLinker, INotifyPropertyChanged
    {
        ...
        protected void Run(in Action action, in BitmapSourcesLinkerLoadStep? loadStep)
        {
        ...
        protected void Run2(ref BitmapSource value, Func<IBitmapSources, BitmapSource> selector, ref BitmapSourcesLinkerLoadStep loadStep) => WinCopies.UtilHelpers.Lambda((in Action action, in BitmapSourcesLinkerLoadStep _loadStep) => Run(action, _loadStep), (ref BitmapSourcesLinkerLoadStep __loadStep, ref BitmapSource __value) =>
        {
            IBitmapSources bitmapSources = GetBitmapSources(__loadStep);
        ...
        protected IBitmapSources GetBitmapSources(BitmapSourcesLinkerLoadStep loadStep)
        {
            switch (loadStep)
            {
                case BitmapSourcesLinkerLoadStep.Default:

                    return InnerObject.Intermediate;

                case BitmapSourcesLinkerLoadStep.Intermediate:

                    return InnerObject.Sources;
