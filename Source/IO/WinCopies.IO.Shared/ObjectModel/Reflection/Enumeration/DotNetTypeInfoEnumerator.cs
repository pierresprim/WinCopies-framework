...
namespace WinCopies.IO.Reflection
{
    ...
    public sealed class DotNetTypeInfoEnumerator : Enumerator<TypeInfo, IDotNetItemInfo>
    {
        private Predicate<DotNetTypeEnumeratorStruct> _func;
        private IEnumerable<DotNetItemType> _enumerable;
    }
}
