...
namespace WinCopies.Collections.AbstractionInterop.Generic
{
    ...
    {
        public class Stack<TStack> : IStack<TDestination> where TStack : IStack<TSource>
        {
            ...
            public Stack(in TStack Stack) => InnerStack = Stack;
        ...
        {
            public Stack(in IStack<TSource> Stack) : base(Stack)
            {
                // Left empty.
            }
        }
