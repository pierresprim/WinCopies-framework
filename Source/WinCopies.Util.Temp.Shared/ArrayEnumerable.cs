...
using WinCopies.Temp.Collections.DotNetFix;

namespace WinCopies.Temp.Collections.Abstraction.Generic
{
    ...
    public interface IArrayEnumerable<T> : IReadOnlyArrayEnumerable<T>, DotNetFix.IArray<T>
    {
