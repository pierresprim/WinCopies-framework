                ...
                _ = UpdateValue(ref screen, value, (Screen oldScreen, Screen newScreen) =>
  {
      ...
      if (newScreen != null)
      {
        ...
        public void Initialize(in CursorPosition cursorPosition)
        {
            ...
            Temp.Temp.DeleteConsoleMenu(new KeyValuePair<SystemMenuCommands, MenuFlags>(SystemMenuCommands.Maximize, MenuFlags.ByCommand), new KeyValuePair<SystemMenuCommands, MenuFlags>(SystemMenuCommands.Size, MenuFlags.ByCommand));
